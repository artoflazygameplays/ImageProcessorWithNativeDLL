...
- Create Angular project with ng: `ng new 3dhistechhomework.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`3dhistechhomework.client.esproj`).
